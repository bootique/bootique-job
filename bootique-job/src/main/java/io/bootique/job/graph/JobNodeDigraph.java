 ...
 * @since 3.0
 */
public class JobNodeDigraph extends Digraph<JobNode> {

    public static Builder builder(Map<String, JobGraphNode> nodes) {
    ...
    public static class Builder {
        ...
        protected Builder(Map<String, JobGraphNode> nodes) {
